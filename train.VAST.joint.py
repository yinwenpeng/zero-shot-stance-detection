    ...
    def get_VAST_new(self, filelists):
        ...
        for fil in filelists:
            ...
            for i in range(0, len(lines), 4):
                ...
                examples.append(InputExample(guid="randomstr", text_a=premise, text_b=hypothesis, label=label))
...
'''
CUDA_VISIBLE_DEVICES=3 python -u train.VAST.joint.py --task_name rte --do_train --do_lower_case --num_train_epochs 20 --train_batch_size 24 --eval_batch_size 32 --learning_rate 1e-3 --max_seq_length 205 --seed 42
